...
class Order:
    def __init__(self, orderNum, name, phoneNumber, email, url, numCards, paymentMethod, deliveryMethod="campus", note=None, street=None, city=None, state=None, zipCode=None):
